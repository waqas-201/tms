      ...
      <div className="relative mx-auto max-w-2xl bg-[#faf8f5] rounded-xl shadow-2xl border border-[#e6dfd5] overflow-hidden">
        ...
        <div className="flex items-center px-4 py-3.5 border-b border-[#e6dfd5] bg-white">
          ...
          {query && (
            <button
              onClick={() => setQuery("")}
              className="p-1 text-[#6a6660] hover:text-[#123824] mr-1"
            >
              <X className="w-4 h-4" />
            </button>
          )}
          <button
            onClick={onClose}
            className="text-xs font-semibold text-[#123824] bg-[#f4eee5] px-2.5 py-1 rounded hover:bg-[#e8ded2] transition-colors shrink-0"
          >
            ESC
          </button>
        </div>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <button
                  ...
                  className="text-xs px-3 py-1.5 bg-white border border-[#e6dfd5] rounded-full text-[#123824] hover:bg-[#123824] hover:text-white hover:border-[#123824] transition-all"
                >
                  {chip}
                </button>
              ))}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {product.badge && (
                        <span className="text-[9px] px-1.5 py-0.5 bg-[#123824]/10 text-[#123824] rounded">
                          {product.badge}
                        </span>
                      )}
                    </div>
                    <h4 className="text-sm font-medium text-[#123824] group-hover:text-[#c59b27] transition-colors truncate">
                      {product.name}
                    </h4>
                  ...
                  <div className="text-right shrink-0">
                    <div className="text-sm font-semibold text-[#123824]">
                      ₨ {product.price.toLocaleString()}
                    </div>
                    <div className="text-[11px] text-[#256644] font-medium flex items-center justify-end gap-1">
                      <span>View</span>
