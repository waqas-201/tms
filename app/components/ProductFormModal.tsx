...
export default function ProductFormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto p-3 sm:p-6 md:p-10 flex items-center justify-center">
      ...
      <div
        onClick={onClose}
        className="fixed inset-0 bg-[#123824]/60 backdrop-blur-xs transition-opacity animate-fade-in"
      />
      ...
      <div className="relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl border border-[#e6dfd5] overflow-hidden my-auto max-h-[90vh] flex flex-col animate-fade-in">
        ...
        <div className="px-6 py-4 border-b border-[#e6dfd5] bg-[#faf8f5] flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-[#123824] text-[#c59b27] flex items-center justify-center">
              <Package className="w-4 h-4" />
            </div>
            <div>
              <h2 className="font-serif text-lg font-bold text-[#123824]">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-md text-[#6a6660] hover:text-[#123824] hover:bg-[#e6dfd5]/50 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6 text-xs">
          ...
          <div className="bg-[#faf8f5] p-5 rounded-xl border border-[#e6dfd5] space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="font-bold text-[#123824] flex items-center gap-1.5 text-sm">
              ...
              <div className="flex gap-1 bg-white p-0.5 rounded-md border border-[#e6dfd5]">
                <button
                  ...
                  className={`px-2.5 py-1 rounded text-[11px] font-medium transition-colors ${
                    imageTab === "upload"
                      ? "bg-[#123824] text-white font-semibold"
                      : "text-[#6a6660] hover:text-[#123824]"
                  }`}
                >
                  Upload File
                </button>
                ...
                {imageTab === "upload" ? (
                  <div className="bg-white p-4 rounded-xl border border-dashed border-[#c59b27] text-center space-y-2">
                    <UploadDropzone
                      ...
                      appearance={{
                        button: "bg-[#123824] hover:bg-[#0c2719] text-xs font-semibold py-2 px-4 rounded-md",
                        container: "border-none p-2",
                        label: "text-xs font-medium text-[#123824]",
                        allowedContent: "text-[10px] text-[#6a6660]",
                      }}
                    />
                    {uploadSuccess && (
                      <p className="text-[#256644] font-semibold flex items-center justify-center gap-1">
                    ...
                    <div className="flex flex-wrap gap-1.5 pt-1">
                      ...
                      {[
                        ...
                        <button
                          ...
                          className="text-[10px] px-2 py-0.5 bg-[#faf8f5] hover:bg-[#e6dfd5] rounded text-[#123824] border border-[#e6dfd5]"
                        >
          ...
          <div className="bg-white p-5 rounded-xl border border-[#e6dfd5] space-y-4">
            <h3 className="font-bold text-[#123824] flex items-center gap-1.5 text-sm border-b border-[#f4eee5] pb-2">
              <Layers className="w-4 h-4 text-[#123824]" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="space-y-1 sm:col-span-2">
                ...
                <input
                  ...
                  className="w-full p-2.5 bg-[#faf8f5] border border-[#e6dfd5] rounded-lg text-[#1a1816] focus:outline-none focus:border-[#123824] font-medium"
                />
              </div>
            ...
            <div className="bg-[#faf8f5] p-5 rounded-xl border border-[#e6dfd5] space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 bg-[#123824] text-white rounded-lg font-semibold shrink-0"
                >
              ...
              <div className="flex flex-wrap gap-1 pt-1">
                ...
                {PRESET_BENEFITS.slice(0, 4).map((p) => (
                  <button
                    ...
                    className="text-[10px] px-2 py-0.5 bg-white border border-[#e6dfd5] rounded-full text-[#123824] hover:bg-[#123824] hover:text-white transition-colors"
                  >
                    + {p.slice(0, 24)}...
                  </button>
                ))}
              ...
              <div className="space-y-1.5 max-h-40 overflow-y-auto pr-1">
                {benefitsList.map((b, i) => (
                  ...
                  >
                    <span className="text-[#123824]">{b}</span>
                    <button
                      type="button"
            ...
            <div className="bg-[#faf8f5] p-5 rounded-xl border border-[#e6dfd5] space-y-3">
              ...
              <div className="space-y-1.5 max-h-40 overflow-y-auto pr-1">
                {ingredientsList.map((ing, i) => (
                  ...
                  >
                    <div>
                      <span className="font-bold text-[#123824]">{ing.name}</span>
          ...
          <div className="bg-white p-5 rounded-xl border border-[#e6dfd5] space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 items-center">
              ...
              <button
                type="button"
                onClick={addSize}
                className="py-2 px-3 bg-[#123824] hover:bg-[#0c2719] text-white rounded-lg font-semibold flex items-center justify-center gap-1"
              >
                <Plus className="w-3.5 h-3.5" />
                <span>Add Size</span>
              </button>
              ...
              {sizesList.map((s, i) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className="font-bold text-[#123824]">{s.name}</span>
                    <span className="text-[#6a6660]">({s.weight})</span>
                    <span className="font-bold text-[#256644]">₨ {Number(s.price).toLocaleString()}</span>
                  </div>
                  <button
                    type="button"
            ...
            <div className="flex flex-wrap gap-6 pt-3 border-t border-[#f4eee5]">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 accent-[#123824] rounded"
                />
                <span className="font-semibold text-[#123824]">Available in Stock</span>
              </label>
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="font-semibold text-[#123824]">
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-[#e6dfd5]">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2.5 bg-[#123824] hover:bg-[#0c2719] text-white font-semibold rounded-lg transition-colors shadow-md flex items-center gap-2 disabled:opacity-50"
            >
              {loading ? (
                <>
