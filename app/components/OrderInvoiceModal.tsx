...
export default function OrderInvoiceModal({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto p-3 sm:p-6 md:p-10 flex items-center justify-center">
      ...
      <div
        onClick={onClose}
        className="fixed inset-0 bg-[#123824]/60 backdrop-blur-xs transition-opacity animate-fade-in print:hidden"
      />
      ...
      <div className="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl border border-[#e6dfd5] overflow-hidden my-auto max-h-[95vh] flex flex-col animate-fade-in print:max-w-none print:shadow-none print:border-none print:m-0 print:p-0">
        ...
        <div className="px-6 py-3.5 border-b border-[#e6dfd5] bg-[#faf8f5] flex items-center justify-between shrink-0 print:hidden">
          <div className="flex items-center gap-2 text-xs font-semibold text-[#123824]">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-[#123824] hover:bg-[#0c2719] text-white text-xs font-semibold rounded-md shadow-xs transition-colors"
            >
        ...
        >
          {/* Header Branding */}
          <div className="flex flex-col sm:flex-row justify-between sm:items-start border-b-2 border-[#123824] pb-6 gap-4">
            <div className="flex items-center gap-3">
              <div className="relative w-12 h-12 rounded-full overflow-hidden bg-[#123824] shrink-0 border border-[#c59b27]">
                <Image
                  src="/images/logo.png"
              ...
              <div>
                <h1 className="font-serif text-xl sm:text-2xl font-bold text-[#123824] tracking-tight">
                  TAMEER-E-SEHAT
                </h1>
                ...
                <p className="text-[11px] text-[#59534b]">
                  {CLINIC_INFO.address.clinic}, Karachi, Pakistan
                </p>
                <p className="text-[11px] text-[#59534b]">
            ...
            <div className="text-left sm:text-right space-y-1">
              <span className="text-[10px] font-mono uppercase tracking-widest font-bold px-2 py-0.5 bg-[#f2f9f5] text-[#256644] rounded border border-[#d2eadc]">
                CASH ON DELIVERY (COD)
              </span>
              <h3 className="font-mono text-sm font-bold text-[#123824] pt-1">
                {invoiceNumber}
              </h3>
              ...
              <p className="text-[11px] text-[#6a6660]">
                Order Ref: <span className="font-mono font-bold text-[#123824]">{order.orderNumber}</span>
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 p-4 rounded-xl bg-[#faf8f5] border border-[#e6dfd5] text-xs">
            <div className="space-y-1">
              ...
              <p className="font-serif text-base font-bold text-[#123824]">
                {order.customerName}
              </p>
            ...
            <div className="space-y-1">
              ...
              <p className="font-bold text-[#123824]">{order.city}, Pakistan</p>
              {order.deliveryNotes && (
          ...
          <div className="border border-[#e6dfd5] rounded-xl overflow-hidden text-xs">
            <table className="w-full text-left">
              <thead className="bg-[#123824] text-white">
                <tr>
              ...
              <tbody className="divide-y divide-[#e6dfd5] bg-white">
                {order.items?.map((item: any, idx: number) => (
                  <tr key={item.id || idx}>
                    ...
                    <td className="p-3 font-semibold text-[#123824]">
                      {item.productName}
                    </td>
                    ...
                    <td className="p-3 text-right font-bold text-[#123824]">
          ...
          <div className="flex justify-end pt-2">
            <div className="w-full sm:w-72 space-y-2 text-xs">
              ...
              <div className="flex justify-between text-base font-bold text-[#123824] pt-2 border-t-2 border-[#123824]">
          ...
          <div className="pt-8 border-t border-[#e6dfd5] flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-[#6a6660]">
            <div className="space-y-1 text-center sm:text-left">
              <p className="font-semibold text-[#123824] flex items-center gap-1">
                <ShieldCheck className="w-3.5 h-3.5 text-[#256644]" />
            ...
            <div className="text-center sm:text-right">
              <div className="w-36 border-b border-[#123824] pb-1 mx-auto sm:ml-auto">
                <span className="font-serif italic text-[#123824] text-xs">Hakim Sahib</span>
              </div>
